...
from asynfed.commons.messages.server.server_response_to_init import ExchangeAt
...
class ServerConfig(MessageObject):
    def __init__(self, server_id: str, ping_period: int = 300, save_log: bool = True, 
                 update_conditions: dict = None, stop_conditions: dict = None, model_exchange_at: dict = None, 
                 cleaning_config: dict = None, cloud_storage: dict = None, queue_consumer: dict = None,
                 queue_producer: dict = None, influxdb: dict = None
                 ):
        ...
        # these 3 object provide default values
