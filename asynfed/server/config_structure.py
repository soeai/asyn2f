...
class ServerConfig(MessageObject):
    def __init__(self, server_id: str, model_name: str = None, ping_period: int = 300, save_log: bool = True, 
                 stop_conditions: dict = None, model_exchange_at: dict = None, 
        ...
        self.model_name = model_name or server_id
