        ...
        # for epoch in range(EPOCHS):
            ...
            for images, labels in self.train_ds:
                ...
                # previous, current and global weights are used in the merged process
                    ...
                    LOGGER.info(f"Merging process happens at epoch {epoch_num}, batch {batch_num} when receiving the global version {self.current_local_version}, current global version {self.previous_local_version}")
            ...
            message = ClientNotifyModelToServer(
                ...
                model_id=self.current_local_version,
