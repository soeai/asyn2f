...
default_testing_dataset_path = "experiment/data/cifar_data/test_set.pickle"
training_dataset_path = f"experiment/data/cifar_data/5_chunks/chunk_{config['training_params']['chunk_index']}.pickle"
