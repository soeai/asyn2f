...
from experiment.cifar10.resnet18 import Resnet18
from experiment.cifar10.data_preprocessing import preprocess_dataset
...
parser.add_argument('--queue_exchange', dest='queue_exchange', type=str, default="cifar10-10-chunks-non-overlap-gpu-non-iid", help='specify the queue exchange')
...
chunk_folder = os.path.join("10_chunks", "non_iid")
